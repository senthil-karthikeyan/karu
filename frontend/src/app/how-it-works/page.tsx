    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 py-16 md:py-24">
        <div className="container mx-auto px-4 sm:px-8 max-w-5xl space-y-16">
          ...
          <div className="space-y-12">
            {WORKFLOW_STEPS.map((item) => {
              ...
              return (
                <div
                  key={item.step}
                  className="p-6 sm:p-8 rounded-2xl border border-border/80 bg-card shadow-sm hover:shadow-md transition-shadow grid grid-cols-1 lg:grid-cols-12 gap-8 items-center"
                >
          ...
          {/* Bottom CTA Banner */}
          <div className="p-8 sm:p-12 rounded-3xl border border-border/80 bg-card text-center space-y-6 shadow-xl relative overflow-hidden">
